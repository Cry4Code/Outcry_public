...
{
    [SerializeField] private TutorialDataSO skillShopTutorial;
    private const string FirstInteractionKey = "SkillShop_FirstInteraction";
    ...
    public override void Interact()
    {
        ...
        if (PlayerPrefs.GetInt(FirstInteractionKey, 0) == 0)
        {
            ...
            tutoPopup.Setup(skillShopTutorial, () =>
            {
