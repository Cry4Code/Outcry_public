...
public class GoblinFirekeeperStrongAttackSkillSequenceNode : SkillSequenceWithChaseNode
{
    // 경과 시간, 쿨타임 등 계산용
    ...
    // 투사체 생성 프레임
    private const float INSTANTIATE_STONE_TIME = (1.0f / ANIMATION_FRAME_RATE) * 15;    // 16프레임이 지난 시점

    // 투사체 오브젝트
    private GameObject fireball;

    // 투사체 좌표
    private Vector2 position = new Vector2(1.09f, 0.57f);
    ...
    public GoblinFirekeeperStrongAttackSkillSequenceNode(int skillId) : base(skillId)
    {
        this.nodeName = "GoblinFirekeeperStrongAtkNode";
    }
    ...
    public override async void InitializeSkillSequenceNode(MonsterBase monster, PlayerController target)
    {
        ...
        // 투사체 로드
        projectilePath = AddressablePaths.Projectile.Fireball;
    ...
    protected override NodeState SkillAction()
    {
        ...
        */
        ...
        // 애니메이션의 동작 시간에 투사체(Fireball) 생성 로직 실행
