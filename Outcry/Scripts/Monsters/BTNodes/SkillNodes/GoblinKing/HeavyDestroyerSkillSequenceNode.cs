...
public class HeavyDestroyerSkillSequenceNode : SkillSequenceNode
{
    ...
    protected override NodeState SkillAction()
    {
        ...
        if (!skillTriggered)
        {
            ...
            animator.SetTrigger(AnimatorHash.MonsterParameter.HeavyDestroyer); // 돌진 시작 애니메이션 트리거 on
        ...
        else if (AnimatorUtility.IsAnimationPlaying(monster.Animator, AnimatorHash.MonsterAnimation.HeavyDestroyerLoop))
        {
